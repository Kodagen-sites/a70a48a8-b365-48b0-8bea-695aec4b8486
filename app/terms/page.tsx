...
export default function TermsPage() {
  return (
    <>
      <Header />
      <main className="mx-auto max-w-3xl px-5 pb-24 pt-32 text-contrast md:px-8 md:pt-40">
        ...
        <p className="mt-3 text-sm text-contrast/55">Effective {effectiveDate}</p>

        <div className="mt-12 space-y-8 leading-relaxed [&_h2]:mb-3 [&_h2]:mt-10 [&_h2]:font-display [&_h2]:text-xl [&_h2]:text-contrast [&_li]:text-contrast/75 [&_p]:text-contrast/75 [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-6">
          <p>
          ...
          <div>
            ...
            <p>
              {company} provides research, analytics, and informational signals only. Nothing on
              this website constitutes financial, investment, tax, or legal advice, or a
              recommendation to buy or sell any security. Investing involves risk, including the
              possible loss of principal. Past performance does not guarantee future results. You
              are solely responsible for your own investment decisions and should consult a
              licensed financial professional before acting.
            </p>
          </div>
